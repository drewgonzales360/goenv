...
func TestConfigReading(t *testing.T) {
	...
	if err := os.Setenv(cmd.GoEnvRootDirEnvVar, expectedRootDir); err != nil {
		t.Fail()
	}
	if err := os.Setenv(cmd.GoEnvInstallDirEnvVar, expectedInstallDir); err != nil {
		t.Fail()
	}

	leftConfig := cmd.ReadConfig()
	rightConfig := &cmd.Config{
		expectedRootDir,
		expectedInstallDir,
	}
